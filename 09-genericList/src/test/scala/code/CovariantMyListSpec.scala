...
class CovariantMyListSpec extends FlatSpec with Matchers {

  // Helper method to make it easier to build lists.
  // You'll see how this works in the Sequencing Computations section:
  def list[A](items: A *): CovariantMyList[A] =
    items.foldRight[CovariantMyList[A]](CovariantMyNil)(CovariantMyPair[A])
