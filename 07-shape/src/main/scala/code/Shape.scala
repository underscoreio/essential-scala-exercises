...
// - Implement the area method for Shape using pattern matching (match on this):
// - Implement a perimeter method for Shape using inheritance
// - Implement a compare method in the companion object for Shape that
...
// - Implement a scale method for Shape using pattern matching (match on this):
